...
class MarketDataApi:
    ...
    @validate_call
    async def get_market_spot_trade_busts(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results after this sequence number (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results before this sequence number (for pagination)")] = None,
        ...
        """Get spot trade busts for market

        Returns up to 100 spot trade busts (failed spot fills) for a given market.
        ...
        _param = self._get_market_spot_trade_busts_serialize(
            symbol=symbol,
            start_time=start_time,
            end_time=end_time,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_market_spot_trade_busts_with_http_info(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results after this sequence number (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results before this sequence number (for pagination)")] = None,
    ...
    @validate_call
    async def get_market_spot_trade_busts_without_preload_content(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results after this sequence number (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results before this sequence number (for pagination)")] = None,
    ...
    def _get_market_spot_trade_busts_serialize(
        self,
        symbol,
        start_time,
        end_time,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/market/{symbol}/spotTradeBusts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
