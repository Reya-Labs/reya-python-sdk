...
class SpotExecution(BaseModel):
    ...
    taker_order_id: Optional[StrictStr] = Field(default=None, description="Order ID for the taker", alias="takerOrderId")
    ...
    __properties: ClassVar[List[str]] = ["exchangeId", "symbol", "takerAccountId", "makerAccountId", "takerOrderId", "makerOrderId", "side", "qty", "price", "takerFee", "type", "timestamp", "sequenceNumber", "fillId"]
