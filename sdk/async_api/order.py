...
class Order(BaseModel): 
  ...
  qty: Optional[str] = Field(description='''Non-negative decimal string''', default=None)
  exec_qty: Optional[str] = Field(description='''Non-negative decimal string''', default=None, alias='''execQty''')
  side: Side = Field(description='''Order side (B = Buy/Bid, A = Ask/Sell)''')
  limit_px: str = Field(description='''Decimal string''', alias='''limitPx''')
  order_type: OrderType = Field(description='''Order type, (LIMIT = Limit, TP = Take Profit, SL = Stop Loss)''', alias='''orderType''')
  trigger_px: Optional[str] = Field(description='''Decimal string''', default=None, alias='''triggerPx''')
  ...
  created_at: int = Field(description='''Unsigned integer''', alias='''createdAt''')
  last_update_at: int = Field(description='''Unsigned integer''', alias='''lastUpdateAt''')
