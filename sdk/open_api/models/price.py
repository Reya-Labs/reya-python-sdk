...
class Price(BaseModel):
    """
    Deprecated AMM-era mixed market/collateral price shape. Use AssetOraclePrice for asset Stork oracle prices; use market summary/depth endpoints for market prices.
    """ # noqa: E501
