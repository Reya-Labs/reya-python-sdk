...
from sdk.async_api.spot_execution import SpotExecution
class WalletSpotExecutionUpdatePayload(BaseModel): 
  ...
  channel: str = Field(description='''Channel pattern for wallet spot executions''')
  data: List[SpotExecution] = Field()
