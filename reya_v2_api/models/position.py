...
class Position(BaseModel):
    ...
    qty: StrictStr = Field(description="Position quantity (absolute value)")
    side: Side
    avg_entry_price: StrictStr = Field(description="Average entry price", alias="avgEntryPrice")
    avg_entry_funding_value: StrictStr = Field(description="Average entry funding value", alias="avgEntryFundingValue")
    last_trade_sequence_number: Union[StrictFloat, StrictInt] = Field(description="Sequence number of last trade", alias="lastTradeSequenceNumber")
