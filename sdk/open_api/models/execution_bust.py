...
class ExecutionBust(BaseModel):
    ...
    fill_id: Optional[StrictStr] = Field(default=None, description="Stable fill identifier. Use it to correlate the execution bust with its execution and order update.", alias="fillId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "side": obj.get("side"),
            "price": obj.get("price"),
            "reason": ExecutionBustReason.from_dict(obj["reason"]) if obj.get("reason") is not None else None,
