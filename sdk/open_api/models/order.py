...
class Order(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["exchangeId", "symbol", "accountId", "orderId", "qty", "execQty", "cumQty", "side", "limitPx", "orderType", "triggerPx", "timeInForce", "expiresAfter", "reduceOnly", "postOnly", "status", "createdAt", "lastUpdateAt"]
