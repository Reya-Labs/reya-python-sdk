...
class MarketDataApi:
    ...
    async def get_candles(
        ...
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or before this timestamp, in milliseconds (for pagination)")] = None,
        ...
        :type resolution: str
        :param end_time: Return results at or before this timestamp, in milliseconds (for pagination)
        :type end_time: int
    ...
    async def get_market_perp_executions(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or after this timestamp, in milliseconds (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or before this timestamp, in milliseconds (for pagination)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param symbol: Trading symbol (e.g., BTCRUSDPERP) (required)
        :type symbol: str
        :param start_time: Return results at or after this timestamp, in milliseconds (for pagination)
        :type start_time: int
        :param end_time: Return results at or before this timestamp, in milliseconds (for pagination)
        :type end_time: int
        :param _request_timeout: timeout setting for this request. If one
    ...
    @validate_call
    async def get_market_spot_execution_busts(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or after this timestamp, in milliseconds (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or before this timestamp, in milliseconds (for pagination)")] = None,
        ...
        _param = self._get_market_spot_execution_busts_serialize(
            symbol=symbol,
            start_time=start_time,
            end_time=end_time,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_market_spot_execution_busts_with_http_info(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or after this timestamp, in milliseconds (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or before this timestamp, in milliseconds (for pagination)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SpotExecutionBustList]:
        """Get spot execution busts for market
    ...
    @validate_call
    async def get_market_spot_execution_busts_without_preload_content(
        self,
        symbol: Annotated[str, Field(strict=True, description="Trading symbol (e.g., BTCRUSDPERP)")],
        start_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or after this timestamp, in milliseconds (for pagination)")] = None,
        end_time: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Return results at or before this timestamp, in milliseconds (for pagination)")] = None,
    ...
    def _get_market_spot_execution_busts_serialize(
        self,
        symbol,
        start_time,
        end_time,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/market/{symbol}/spotExecutionBusts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
