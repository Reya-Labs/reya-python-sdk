...
class Price(BaseModel):
    """
    Deprecated AMM-era mixed market/collateral price shape. Use CollateralOraclePrice for collateral Stork oracle prices; use market summary/depth endpoints for market prices.
    """ # noqa: E501
    ...
    @field_validator('pool_price')
    def pool_price_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
