...
class MarketMakerState:
    ...
    def update_order(self, order_id: str, status: str, price: Decimal, qty: Decimal, cum_qty: Decimal, is_buy: bool) -> None:
...
def generate_random_qty(min_qty: Decimal, max_qty: Decimal, qty_step_size: Decimal) -> str:
    ...
    random_offset = qty_range * Decimal(random.uniform(0.0, 1.0))
...
async def fetch_initial_state(
    ...
    logger.info(f"   Fetching account balances...")
