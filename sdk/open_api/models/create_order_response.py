...
class CreateOrderResponse(BaseModel):
    ...
    order_id: StrictStr = Field(description="Reya-assigned order ID, generated for all order types including IOC. A no-cross IOC still receives an ID and is returned with status CANCELLED (it never rests).", alias="orderId")
