...
class MarketSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["symbol", "updatedAt", "oiQty", "fundingRate", "longFundingValue", "shortFundingValue", "volume24h", "pxChange24h", "markPrice", "throttledMidPrice", "pricesUpdatedAt"]
