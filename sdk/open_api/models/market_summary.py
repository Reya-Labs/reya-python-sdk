...
class MarketSummary(BaseModel):
    ...
    mark_price: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="markPrice")
    oracle_price: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="oraclePrice")
    throttled_mid_price: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="throttledMidPrice")
    prices_updated_at: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="pricesUpdatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "updatedAt", "oiQty", "fundingRate", "longFundingValue", "shortFundingValue", "volume24h", "pxChange24h", "markPrice", "oraclePrice", "throttledMidPrice", "pricesUpdatedAt"]
    ...
    def mark_price_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('throttled_mid_price')
    def throttled_mid_price_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "throttledMidPrice": obj.get("throttledMidPrice"),
