...
class ExecutionBust(BaseModel): 
  ...
  fill_id: Optional[str] = Field(description='''Stable fill identifier. Use it to correlate the execution bust with its execution and order update.''', default=None, alias='''fillId''')
