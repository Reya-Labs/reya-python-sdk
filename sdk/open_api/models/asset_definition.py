...
class AssetDefinition(BaseModel):
    ...
    spot_market_symbol: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Trading symbol (e.g., BTCRUSDPERP, WETHRUSD)", alias="spotMarketSymbol")
    ...
    status: StrictStr = Field(description="Status of asset (ENABLED = deposits and withdrawals allowed, WITHDRAWAL_ONLY = only withdrawals allowed)")
    decimals: Annotated[int, Field(strict=True, ge=0)]
    display_decimals: Annotated[int, Field(strict=True, ge=0)] = Field(alias="displayDecimals")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asset", "spotMarketSymbol", "priceHaircut", "liquidationDiscount", "status", "decimals", "displayDecimals"]
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ENABLED', 'WITHDRAWAL_ONLY']):
            raise ValueError("must be one of enum values ('ENABLED', 'WITHDRAWAL_ONLY')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "displayDecimals": obj.get("displayDecimals")
        })
