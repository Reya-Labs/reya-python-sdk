...
class Price(BaseModel):
    ...
    oracle_price: Optional[StrictStr] = Field(default=None, description="Oracle price", alias="oraclePrice")
    pool_price: Optional[StrictStr] = Field(default=None, description="Pool price", alias="poolPrice")
    price: Optional[StrictStr] = Field(default=None, description="Current price")
    updated_at: Union[StrictFloat, StrictInt] = Field(description="Last update timestamp (milliseconds)", alias="updatedAt")
    __properties: ClassVar[List[str]] = ["symbol", "oraclePrice", "poolPrice", "price", "updatedAt"]
