...
class Order(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["exchangeId", "symbol", "accountId", "orderId", "sequenceNumber", "clientOrderId", "qty", "execQty", "cumQty", "firstFillId", "fillCount", "side", "limitPx", "orderType", "triggerPx", "timeInForce", "expiresAfter", "reduceOnly", "postOnly", "status", "createdAt", "lastUpdateAt", "cancelReason", "cancelReasonMessage"]
