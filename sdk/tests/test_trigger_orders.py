...
def assert_position_changes(positions_before: Position | None, positions_after: Position, execution_details: PerpExecution):
...
async def test_success_ioc(reya_tester: ReyaTester, test_qty, test_is_buy):
    ...
    try:
        ...
        assert persisted_trade_sequence_number == order_execution_details.sequence_number, "Sequence number should match"
