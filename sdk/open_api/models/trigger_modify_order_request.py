...
class TriggerModifyOrderRequest(BaseModel):
    ...
    reduce_only: Optional[Any] = Field(default=None, description="Must be omitted for TP/SL, including false. The signed value is reconstructed as false.", alias="reduceOnly")
    post_only: Optional[Any] = Field(default=None, description="Must be omitted for TP/SL, including false. The signed value is reconstructed as false.", alias="postOnly")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TriggerModifyOrderRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reduce_only (nullable) is None
        # and model_fields_set contains the field
        if self.reduce_only is None and "reduce_only" in self.model_fields_set:
            _dict['reduceOnly'] = None

        # set to None if post_only (nullable) is None
        # and model_fields_set contains the field
        if self.post_only is None and "post_only" in self.model_fields_set:
            _dict['postOnly'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TriggerModifyOrderRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            **({"reduceOnly": obj["reduceOnly"]} if "reduceOnly" in obj else {}),
            **({"postOnly": obj["postOnly"]} if "postOnly" in obj else {})
        })
        return _obj
