...
class CancelOrderRequest(BaseModel):
    ...
    CancelOrderRequest
    """ # noqa: E501
    order_id: StrictStr = Field(description="Order ID to cancel", alias="orderId")
    signature: StrictStr = Field(description="Cancellation signature")
    __properties: ClassVar[List[str]] = ["orderId", "signature"]
