...
class AccountBalance(BaseModel):
    ...
    balance_deprecated: Annotated[str, Field(strict=True)] = Field(alias="balance_DEPRECATED")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountId", "asset", "realBalance", "balance_DEPRECATED"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balance_DEPRECATED": obj.get("balance_DEPRECATED")
        })
