...
class FeeTierParameters(BaseModel):
    ...
    FeeTierParameters
    """ # noqa: E501
    tier_id: Union[StrictFloat, StrictInt] = Field(description="Fee tier identifier", alias="tierId")
    taker_fee: StrictStr = Field(description="Taker fee rate", alias="takerFee")
    maker_fee: StrictStr = Field(description="Maker fee rate", alias="makerFee")
    volume14d: StrictStr = Field(description="14-day volume threshold")
