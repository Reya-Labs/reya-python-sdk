...
class AccountBalance(BaseModel):
    ...
    balance_deprecated: Annotated[str, Field(strict=True)] = Field(alias="balanceDEPRECATED")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountId", "asset", "realBalance", "balanceDEPRECATED"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balanceDEPRECATED": obj.get("balanceDEPRECATED")
        })
