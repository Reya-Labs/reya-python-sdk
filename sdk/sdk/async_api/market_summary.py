...
class MarketSummary(BaseModel): 
  symbol: str = Field()
  updated_at: float = Field(description='''Time when the market summary was last calculated (milliseconds)''', alias='''updatedAt''')
  ...
  prices_updated_at: Optional[float] = Field(description='''Timestamp of the last price update (milliseconds)''', default=None, alias='''pricesUpdatedAt''')
