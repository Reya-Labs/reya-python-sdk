...
class WalletDataApi:
    ...
    @validate_call
    def get_wallet_account_balances(
        self,
        address: Annotated[str, Field(strict=True, description="Ethereum wallet address")],
        ...
        Returns balances for all accounts belonging to a wallet

        :param address: Ethereum wallet address (required)
        :type address: str
    ...
    @validate_call
    def get_wallet_account_balances_with_http_info(
        self,
        address: Annotated[str, Field(strict=True, description="Ethereum wallet address")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_wallet_account_balances_without_preload_content(
        self,
        address: Annotated[str, Field(strict=True, description="Ethereum wallet address")],
        _request_timeout: Union[
            None,
    ...
    def get_wallet_perp_executions(
        ...
        """Get wallet perpetual executions

        Returns perpetual contract executions for a wallet
    ...
    def get_wallet_positions(
        ...
        Returns all positions for a wallet across all markets
    ...
    def get_wallet_spot_executions(
        ...
        Returns spot executions (collateral liquidations) for a wallet
