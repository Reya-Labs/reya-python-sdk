...
class MarketSummary(BaseModel): 
  ...
  long_funding_value: str = Field(description='''Current long funding value''', alias='''longFundingValue''')
  short_funding_value: str = Field(description='''Current short funding value''', alias='''shortFundingValue''')
